document.addEventListener('DOMContentLoaded', function () {
  ...
  function getErrorMessage(type, fieldName, extra) {
    const messages = {
      ...
      minlength: 'Minimum length is ' + extra + ' characters.',
      maxlength: 'Maximum length is ' + extra + ' characters.',
    };
  ...
  style.textContent = [
    ...
    '}',
    '[dir="rtl"] .fade-in-element {',
    '  transform: translateY(24px);',
    '}',
    '[dir="rtl"] .fade-in-element.fade-in-visible {',
    '  transform: translateY(0);',
    '}',
  ].join('\n');
  ...
  // ─── Staggered animation for grouped children ─────────────────────────────
  ...
  const staggerParents = document.querySelectorAll(staggerParentSelectors);

  staggerParents.forEach(function (parent) {
    const children = parent.querySelectorAll('.' + OBSERVE_CLASS);
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '6742ebd4-ff8b-4b3e-911b-06d080666cae',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '6742ebd4-ff8b-4b3e-911b-06d080666cae';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6742ebd4-ff8b-4b3e-911b-06d080666cae';
